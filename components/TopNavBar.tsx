...
// Filter and search (New Steps [navbar-4]/[navbar-5], placeholder toggles
// only) are hidden entirely while the sidebar is open, per "no other buttons
// should be clickable or visible" — the sidebar has full touch/visual
// priority over the rest of the top bar when active.
export default function TopNavBar({
  ...
  return (
    <nav className="fixed inset-x-4 top-4 z-[70] flex items-center justify-between">
      <button
        type="button"
        aria-label="Menu"
